...
#  4  plot4 function to generate Plot4 as required. The rest of functions
...
plot4 <- function(){
  # initialization
  message("plot4. initializate.............")
  initialize()
  
  message("plot4. load filtered data.......")
  dataset <- loaddataset()
  
  # closes device first
  dev.off()
  
  message("plot4. generate plot............")
  # opens png device
  png(filename="plot4.png")
  
  # generate plot and close device (widht and height by default 480px)
  #
  # set device rows and columns
